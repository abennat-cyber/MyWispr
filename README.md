...
[![Download](https://img.shields.io/badge/Download-v0.4.8-blue?style=for-the-badge&logo=apple)](https://github.com/abennat-cyber/MyWispr/releases/download/v0.4.8/MyWispr-0.4.8.dmg)
...
**[MyWispr-0.4.8.dmg](https://github.com/abennat-cyber/MyWispr/releases/download/v0.4.8/MyWispr-0.4.8.dmg)** — macOS 14+ · Apple Silicon
...
- **v0.4.8** — Preserve sentence capitalization when dictating into editors with ghost placeholder text.
- **v0.4.7** — Fix a crash that made every dictation quit the app on macOS 26, and stop the Apple Speech live preview from running on other transcription engines.
- **v0.4.6** — Release v0.4.6.
